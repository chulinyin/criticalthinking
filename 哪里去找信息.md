...
* **评估你的信息来源**
  ...
  * > Does the source make extravagant assertions? Consider the assertion that astronauts never really landed on the  moon but, instead, the entire story was manufactured by NASA. Also, the assertion that the people responsible for the  loss of several thousand lives on 9\/11 were not foreign terrorists, as reported, but instead George W. Bush and  members of his administration planned and executed the horrible events. Both examples qualify as extravagant—that  is, beyond credibility— because they are inconsistent with voluminous photographic evidence and analytical data.  Although we cannot rule out the possibility that these or other conspiracy theories are valid, that possibility is so  remote that anyone who traffics in such theories should be considered unreliable.
    ...
    **原始资料是否作了不切实际的主张？**考虑下面这些主张：宇航员从没有真正登陆欲求，取而代之的是，整个故事都是被NASA操控；造成数千人死亡的911的原因不是外国恐怖分子，据报道，取而代之的是小布什和他的政府成员策划并执行了恐怖事件。这两个例子都够得上是不切实际的——那时超出可信度的——**因为它们与大量照片证据和数据分析不一致。虽然我们不能排除这些或其他阴谋论是有效的可能性， 但是那种可能性是如此的微小以致于任何这样的理论的人都应该被认为是不可靠的。**
