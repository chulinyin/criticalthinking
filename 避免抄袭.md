...
第一步：**当你正在研究一个主题时，把你的原始自己的想法和你自己的分离。首先保留你查阅的每个信息来源的记录。**对于一个互联网来源，记录网站地址、项目的作者和标题、以及你访问网站的日期；对于一本书，记录作者、标题、出版地、出版商、出版日期；对于一本杂志或者期刊文章，记录作者、标题、出版物名称、和它的发行日期；对于一个电视或者无线电广播，记录节目名称，电台，播送日期。
